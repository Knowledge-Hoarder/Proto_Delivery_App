...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    String orderNum;
    public ExpandableListAdapter(Context context, int maxWidth, int run, String cltName,int orderStatus,int packStatus) {
        this.context = context;

        orders = LocalStorageManager.getInstance(context).getOrders(run, cltName,orderStatus);
        List<Packs> mpL = LocalStorageManager.getInstance(context).getPacksPerOrder(orders,packStatus);
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (!Objects.equals(packs.get(0).getHasMPack(), "")) {
            ...
            if(bool){
                ...
                view.findViewById(R.id.ilcDeets).setVisibility(View.INVISIBLE);
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        ImageView moreInfo = view.findViewById(R.id.ilcDeets);
        writeNote(moreInfo, model.getPackId());
        return view;
    }
